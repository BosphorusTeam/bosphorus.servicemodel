...
{
    public class InputMessageActionProvider : IMessageActionProvider
    {
        private readonly IServiceNamespaceBuilder serviceNamespaceBuilder;

        public InputMessageActionProvider(IServiceNamespaceBuilder serviceNamespaceBuilder)
        {
        ...
        public string Get(ContractDescription contractDescription, OperationConfiguration operationConfiguration)
        {
            ...
            string path = string.Format("{0}/{1}", serviceType.Name, methodInfo.Name);
